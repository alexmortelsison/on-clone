...
export default function Navbar() {
  ...
  return (
    <div className="absolute md:px-12 pt-4 w-full text-white z-10 font-noto">
      <div className="flex justify-between items-center">
        ...
        <div className="lg:inline-flex items-center md:pr-8 hidden">
          <div className="space-x-8 pr-90 text-xl font-bold flex">
          ...
          <div className="lg:flex items-center space-x-6 font-bold hidden">
            {iconlinks.map((item, index) => (
              <Link key={index} href={item.link}>
                {item.icon}
              </Link>
